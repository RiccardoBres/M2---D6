/*l tuo compito è creare un sito e-commerce per Smartphones. L'homepage che stai per creare sarà la vetrina dei prodotti disponibili, con qualche informazione per ciascun prodotto. Non sono richieste funzionalità di carrello/cassa.
...
//document.getElementById("Title").innerText = "Magic Shop";
...
//document.getElementById("finalpart").innerText = "Via Rossini 150";

//ES.10;

/*let changeClass = document.querySelectorAll('a');
for (let i = 0; i < changeClass.length; i++) {
    changeClass[i].classList.add("NuovaClasse");
} console.log (changeClass)*/

//ES.11;

/*let changeVisibility = document.querySelectorAll('img');
for (let i = 0; i < changeVisibility.length; i++) {
    changeVisibility[i].classList.toggle("NuovaClasse");
} console.log (changeVisibility) */


//ES.12;

/*let changeColor = document.getElementsByClassName('price');
